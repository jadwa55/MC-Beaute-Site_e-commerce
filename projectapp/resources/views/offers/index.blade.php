    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="{{ route('offers.index') }}" class="active"><span class="las la-user-circle"></span>
                    <span>Offers</span></a>
                </li>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('offers.destroy', $ofr->id) }}" method="POST">

                                                    <a href="{{ route('offers.show', $ofr->id) }}" title="show">
                                                        <i class="fas fa-eye text-success  fa-lg"></i>
                                                    </a>

                                                    <a href="{{ route('offers.edit', $ofr->id) }}">
