    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="{{ route('abouts.index') }}" class="active"><span class="las la-user-circle"></span>
                    <span>About</span></a>
                </li>
                ...
                <div class="project" style="margin-top: 30px">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button><a class="btn btn-success" href="{{ route('abouts.create') }}" title="Create a project"> <i class="fas fa-plus-circle"></i>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('abouts.destroy', $abt->id) }}" method="POST">

                                                    <a href="{{ route('abouts.show', $abt->id) }}" title="show">
                                                        <i class="fas fa-eye text-success  fa-lg"></i>
                                                    </a>

                                                    <a href="{{ route('abouts.edit', $abt->id) }}">
